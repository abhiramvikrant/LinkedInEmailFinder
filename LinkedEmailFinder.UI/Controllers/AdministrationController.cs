...
namespace LinkedEmailFinder.UI.Controllers
{
    ...
    public class AdministrationController : Controller
    {
        ...
        public AdministrationController(RoleManager<IdentityRole> rmanager, UserManager<ApplicationUser> umanager)
        {
        ...
        public async Task<IActionResult> ListUsersInRole(string roleid)
        {
            ...
            foreach (var item in ulist)
            {
                var u = new UserRoles()
                {
                    ...
                    UserId = item.Id,
                    IsInRole =
                    await umanager.IsInRoleAsync(new ApplicationUser()
        ...
        public async Task<IActionResult> ListUsersInRole(List<UserRoles> models, string roleid)
        {
            ...
            foreach (var item in models)
            {
                ...
                //ApplicationUser u = new ApplicationUser() { UserName = item.UserName, Id = item.UserId };
